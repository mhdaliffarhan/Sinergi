<template>
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full gap-3">
    ...
    <div class="flex items-center gap-2 flex-shrink-0 justify-end sm:ml-2">
      ...
      <button @click="$emit('hapus', dokumen.id)" class="p-2 rounded-full text-gray-500 hover:bg-red-100 hover:text-red-600 dark:hover:bg-red-900/50 dark:text-gray-400 dark:hover:text-red-400" title="Hapus Dokumen">
